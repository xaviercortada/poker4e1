...
module.exports = {
  ...
  evalCard: function(card) {
    return this.readRank(card * 4);
    //return this.ranks.readUInt32LE(card * 4);
  },


  readRank: function(position){
      var buf = new Buffer(10);

      var fd = fs.openSync(this.ranksFile, 'r');
...
module.exports.ranksFile = path.join(__dirname, '../data/HandRanks.dat');
